...
## Precondició: <br>_Ha d’haver-hi com a mínim un xat actiu. Si no, va al flux alternatiu “No hi ha xats actius”._

## Flux principal: <br>_1. L’usuari fa clic sobre la pestanya de xats.<br>
...
## Fluxos alternatius: <br>_**No hi ha xats actius**
...
## Postcondició: <br>_El sistema resta a la pantalla de xats, on apareixen tots els xats actius._

## Requeriments no funcionals:

## Prioritat: <br>_Normal_
