...
2. El sistema mostra l’històric de xats actius amb la seva comanda associada, permetent entrar a cadascun.<br>_

## Subfluxos:
(Subfluxos provinents de pas 2.)<br>
        _2.1. Si l’usuari ho desitja, pot entrar en un xat._<br>
